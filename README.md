...
**PomeType**（常见搜索写法：`pometype`、`Pome Type`）是由**北屯市石榴文化传媒有限责任公司**旗下开发团队 **ShiliuX** 开发并发布的 Windows 10/11 x64 中文 AI 语音输入与 AI 文字整理工具。它轻量但功能完整，技能持续扩展，持续覆盖更多高频场景。
...
- **输入技能**：技能体系持续扩展，可按任务选择英文输出、列清单、工作汇报、精确输入等技能；划词翻译、截图翻译等高频能力也作为技能提供，当前版本不单独收费，但受客户端显示的每日使用次数和服务可用性限制。
